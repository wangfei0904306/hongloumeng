...
import com.waskj.hongloumeng.common.DragScaleView;
import com.waskj.hongloumeng.common.MyFragmentPagerAdapter;
import com.waskj.hongloumeng.common.RenderScriptBlur;
import com.waskj.hongloumeng.common.ScreenShot;
import com.waskj.hongloumeng.common.WeiXinShare;
...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blurImage = (ImageView)(findViewById(R.id.image_blur_bg));
        shareDrag = (DragScaleView)findViewById(R.id.share_screen_shot);

        ((TextView)findViewById(R.id.text_share_friend)).setOnClickListener(this);
        ((TextView)findViewById(R.id.text_share_quan)).setOnClickListener(this);
        ((TextView)findViewById(R.id.text_share_shutdown)).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.text_share_friend: {
                Bitmap bitmap = ScreenShot.takeScreenShot(this, shareDrag.getCutX(), shareDrag.getCutY(),
                        shareDrag.getCutWidth(), shareDrag.getCutHeight());
                WeiXinShare wxShare = new WeiXinShare(this, bitmap);
                wxShare.wechatShare(0);
                break;
            }
            case R.id.text_share_quan: {
                Bitmap bitmap = ScreenShot.takeScreenShot(this, shareDrag.getCutX(), shareDrag.getCutY(),
                        shareDrag.getCutWidth(), shareDrag.getCutHeight());
                WeiXinShare wxShare = new WeiXinShare(this, bitmap);
                wxShare.wechatShare(1);
                break;
            }
            default:
                break;
    ...
    public void onLongClick(){
        ...
        TitleActivity.actionStart(this, MAIN_TITLE_RESULT, currIndex);
    }
